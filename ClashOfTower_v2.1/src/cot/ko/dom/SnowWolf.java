...
public class SnowWolf extends Unit
{
	public static Image[][] 	image;
	
	public SnowWolf(Component comp, int x, int y, int dir, String act) 
	{
	...
	public static void initResources(MediaTracker tracker, int id) 
	{
		...
		for (int i = 0; i < 6; i++) 
		{
			for (int j = 0; j < 5; j++) 
			{
				ImageIcon img = new ImageIcon( "res/unit/SnowWolf" + (i) + (j+1) + ".png" );
