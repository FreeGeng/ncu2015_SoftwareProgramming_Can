...
public class TimberWolf extends Unit
{
	public static Image[][] 	image;
	
	public TimberWolf (Component comp, int x, int y, int dir, String act) 
	{
	...
	public static void initResources(MediaTracker tracker, int id) 
	{
		...
		for (int i = 0; i < 6; i++) 
		{
			for (int j = 0; j < 5; j++) 
			{
				ImageIcon img = new ImageIcon( "res/unit/Timberwolf" + (i) + (j+1) + ".png" );
